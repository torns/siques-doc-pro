  ...
  <v-container>
    <v-row justify="center" class="pt-3 collection">
      <v-col
        ...
        xs="12"
      >
        <v-row justify="center" class="collection_wrapper d-flex flex-wrap ">
          <v-col :class="index % 2 == 1 ? colLast : colFirst" xs="12" sm="9" md="8" lg="6" xl="6">
            <div class="cover point">
              ...
              >
                <v-img :src="collect.cover" style="height:400px;border-radius:20px;" fit="cover"></v-img>
              </router-link>
            </div>
          </v-col>
          <v-col
